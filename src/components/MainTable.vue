    ...
    >
      ...
      <vxe-colgroup title="膏深（*10μm）" header-align="center">
        <vxe-colgroup title="1st side" header-align="center">
          ...
          <vxe-column field="attr7" title="右" width="30"></vxe-column>
        </vxe-colgroup>
        <vxe-colgroup title="2nd side" header-align="center">
          <vxe-column field="attr5" title="左" width="30"></vxe-column>
          <vxe-column field="attr6" title="中" width="30"></vxe-column>
